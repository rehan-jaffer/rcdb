...
* Fix display in top right of button (overlaps text right now, text should either be moved down or button should be moved up)
* Check for cross-browser compatibility
* Rewrite JS into OO/clean format
* Add "unrated" to harm/addiction ratings that have 0 votes
